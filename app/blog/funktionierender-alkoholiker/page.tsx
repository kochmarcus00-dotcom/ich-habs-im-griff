...
>
Funktionierender Alkoholiker </h1>
...
```
    ...
    >
      Doch Alkoholabhängigkeit beginnt nicht erst,
    ...
    >
      Viele sogenannte funktionierende Alkoholiker
      leben jahrelang in diesem Zustand.
    </p>
